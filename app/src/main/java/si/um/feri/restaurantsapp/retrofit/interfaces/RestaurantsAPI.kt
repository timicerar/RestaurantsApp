    ...
    interface RestaurantsAPI {
        ...
        fun getRatingsByUserGoogleIdAndRestaurantIdRestaurantAsync(
            @Path("googleUserId") googleUserId: String,
            @Path("restaurantId") restaurantId: Int
        ): Deferred<Response<List<RatingJacksonModel>>>
        ...
        fun getUserByEmailOrGoogleUserIdAsync(@Path("email") email: String, @Path("googleUserId") userGoogleId: String): Deferred<Response<Boolean>>
